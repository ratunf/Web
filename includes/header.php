        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="https://mail.google.com/mail/">ratunf@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a>+6285218855634</a> </div>
            <div class="social-follow">
              <ul>
                <li><a href="https://www.facebook.com/rattu.fauziiah?mibextid=ZbWKwL"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
                <li><a href="https://www.instagram.com/ranufaaa?igsh=Y3RkdGJyNTIyZW56"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
              </ul>
            </div>
